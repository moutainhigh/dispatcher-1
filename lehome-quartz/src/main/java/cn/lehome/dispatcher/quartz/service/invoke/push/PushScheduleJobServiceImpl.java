...
@Service("pushScheduleJobService")
public class PushScheduleJobServiceImpl extends AbstractInvokeServiceImpl{
    ...
    public void doInvoke(Map<String, String> params) {
        ...
        eventBusComponent.sendEventMessage(new LongEventMessage(EventConstants.PUSH_EVENT,Long.valueOf(pushPlanId)));
    }
}
