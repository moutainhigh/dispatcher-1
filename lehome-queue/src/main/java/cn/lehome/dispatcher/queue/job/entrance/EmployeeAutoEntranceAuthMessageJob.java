...
import cn.lehome.dispatcher.queue.listener.entrance.EmployeeAutoEntranceMessageListener;
 ...
 */
@Configuration
public class EmployeeAutoEntranceAuthMessageJob {
    ...
    public DefaultMessageListenerContainer userAutoEntranceAuthMessageJob() {
        ...
        defaultMessageListenerContainer.setMessageListener(employeeAutoEntranceMessageListener());
        defaultMessageListenerContainer.setSessionTransacted(true);
        return defaultMessageListenerContainer;
    }

    @Bean
    public EmployeeAutoEntranceMessageListener employeeAutoEntranceMessageListener() {
        return new EmployeeAutoEntranceMessageListener();
    }
}
