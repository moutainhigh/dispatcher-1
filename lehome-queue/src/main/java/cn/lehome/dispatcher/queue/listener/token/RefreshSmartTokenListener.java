 ...
 */
public class RefreshSmartTokenListener extends AbstractJobListener {
    ...
    public void execute(IEventMessage eventMessage) throws Exception {
        ...
        smartExchangeTokenService.refreshAll(stringEventMessage.getData());
